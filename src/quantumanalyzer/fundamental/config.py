...
APP_NAME: str = "QuantumAnalyzer"
VERSION: str = _load_version()
AUTHOR: str = "Enrico Martini"
GITHUB_REPO: str = "enkas79/QuantumAnalyzer"

# Impostazioni di Rete Centralizzate
HTTP_TIMEOUT: int = 7
HTTP_HEADERS: dict[str, str] = {
    'User-Agent': f'QuantumAnalyzer/{VERSION} (Desktop App; Python)'
}
...
def _get_cache_dir() -> str:
    ...
    cache_dir: str = os.path.join(user_home, ".quantumanalyzer", "cache")
    try:
...
CACHE_DB_PATH: str = os.path.join(_get_cache_dir(), "quantumanalyzer_cache.db")
