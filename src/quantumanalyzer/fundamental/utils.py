...
def setup_logging() -> None:
    ...
    log_dir: str = os.path.join(user_home, ".quantumanalyzer")

    try:
        os.makedirs(log_dir, exist_ok=True)
        log_path: str = os.path.join(log_dir, "quantumanalyzer_debug.log")
    except Exception:
        # Fallback assoluto: usa la cartella dei file temporanei di sistema
        log_path = os.path.join(tempfile.gettempdir(), "quantumanalyzer_debug.log")
...
def encrypt_api_key(api_key: str) -> str:
    ...
    try:
        ...
        salt = b"quantumanalyzer_salt_123"
...
_KEYRING_SERVICE = "QuantumAnalyzer"
