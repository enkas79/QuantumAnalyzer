"""
Vista dell'analisi fondamentale (portata da QuantumValue, PyQt6 -> PySide6).

Contiene le finestre di dialogo e la finestra principale dell'analisi
fondamentale/ETF, delegando i calcoli a quantumanalyzer.fundamental.models
e l'asincronia ai worker QThread di fundamental_workers.
...
from PySide6.QtCore import Qt, QSettings, QTimer, QUrl, QPointF, QStringListModel, QThread

# Importazioni dei moduli interni funzionali
from ..fundamental import utils
from ..fundamental import models
from ..fundamental.config import APP_NAME, VERSION, AUTHOR, GITHUB_REPO, COLORS
from . import theme
from .fundamental_workers import UpdateCheckWorker, SearchWorker, FetchWorker, EtfFetchWorker
