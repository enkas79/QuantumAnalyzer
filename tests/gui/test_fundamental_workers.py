...
# Salta l'intero modulo se PySide6 o pytest-qt non sono disponibili
pytest.importorskip("PySide6.QtCore")
pytest.importorskip("pytestqt")

from quantumanalyzer.fundamental import models
from quantumanalyzer.gui import fundamental_workers as controllers
